...
public class Xx_member {
    ...
    private Date firstCreateOrderDate;
    ...
    public void setSyorganizationId(String syorganizationId) {
        this.syorganizationId = syorganizationId == null ? null : syorganizationId.trim();
    }
    ...
    public Date getFirstCreateOrderDate() {
        return firstCreateOrderDate;
    }

    public void setFirstCreateOrderDate(Date firstCreateOrderDate) {
        this.firstCreateOrderDate = firstCreateOrderDate;
    }
}