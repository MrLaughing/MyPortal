				...
				<div class="formControls col-10">
					<div class="check-box" >
						<table border="0" cellpadding="0" cellspacing="0" style="text-align:left; ">
							  <tr height="28px">
							    <td width="130px"><input id="roles" name="roles" value="1" type="checkbox">总经理</td>
							    <td width="130px"><input id="roles" name="roles" value="2" type="checkbox">副总经理</td>
							  </tr>
						 	  <tr height="28px">
							    <td><input id="roles" name="roles" value="3" type="checkbox">基站管理员</td>
							    <td><input id="roles" name="roles" value="4" type="checkbox">商城管理部</td>
							  </tr>
							  <tr height="28px">
							    <td><input id="roles" name="roles" value="5" type="checkbox">财务管理员</td>
							    <td><input id="roles" name="roles" value="11" type="checkbox">测试人员</td>
							  </tr>
							  <tr height="28px">
							    <td><input id="roles" name="roles" value="7" type="checkbox">废品回收人员</td>
							    <td><input id="roles" name="roles" value="8" type="checkbox">废品回收部</td>
							  </tr>
							   <tr height="28px">
							    <td><input id="roles" name="roles" value="9" type="checkbox">废品回收部</td>
							    <td><input id="roles" name="roles" value="10" type="checkbox">废品回收部</td>
							  </tr>
							</table>
					</div>
				</div>
