		...
		$("#export")
				.on(
						...
						function() {
							...
							var registertime_min = document
									.getElementById("registertime_min").value;
							var registertime_max = document
									.getElementById("registertime_max").value;
							if (orgCode != ""
									|| (registertime_min != "" && registertime_max != "")) {
...
<body>
	...
	地推用户服务设置 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-20">
		...
		<div class="text-c">
			<form action="" name="form1" id="form1" method="post">
				所属基站CODE：<input type="text" class="input-text"
					placeholder="例如200001" style="width: 150px" name="orgCode"
					id="orgCode"> 注册时间段： <input type="text"
