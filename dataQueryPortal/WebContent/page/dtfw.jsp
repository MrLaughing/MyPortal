	...
	$(function() {
		$("#export")
				.on(
						"click",
						function() {
							var sycode = document.getElementById("sycode").value;
							var datetime_min = document
									.getElementById("datetime_min").value;
							var datetime_max = document
									.getElementById("datetime_max").value;
							if (sycode != ""
		...
		<div class="text-c">
			<form action="" name="form1" id="form1" method="post">
				所属基站CODE：<input type="text" class="input-text"
					placeholder="例如200001" style="width: 150px" name="sycode"
					id="sycode"> 注册时间段： <input type="text"
