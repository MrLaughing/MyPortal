...
<body>
	...
	某时段注册用户数 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-20">
		<div class="text-c">
			<form action="" name="form1" method="post">
				...
				请选择时间段：<select name="time" id="time">
					<option value="0">年</option>
					<option value="1">月</option>
					<option value="2">日</option>
					<option value="3">时</option>
				</select> <a href="javascript:;" name="find" id="find"
					class="btn btn-success" onclick="find()"> <i
