...
<script type="text/javascript">
function find() {
	var balance_min =  $("#balance_min").val();
	if (balance_min!="") {
		$('#table').datagrid({
	...
	$(function (){
		$("#export").on("click",function(){
			...
			if(balance_min!=""){
				document.getElementById("form1").action="../distribute/distribute_distribute.action?serialVersionUID=11";
...
<body>
	...
	未购买过商品用户 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-20">
		<div class="text-c">
			<form action="" name="form1" id="form1" method="post">
				最低账户余额： <input type="text" class="input-text" name="balance_min" id="balance_min" 
				placeholder="例如50.00" style="width: 130px;">
