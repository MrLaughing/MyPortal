...
function find() {
	...
	$(function (){
		$("#export").on("click",function(){
			var createDateTime=document.getElementById("createDateTime").value;
			if(createDateTime!=""){
...
<body>
	...
	每日回收金额 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-20">
		<div class="text-c">
			<form action="" name="form1" id="form1" method="post">
				选择日期： <input type="text" onfocus="WdatePicker({maxDate:'%y-%M-%d'})"
					name="createDateTime" class="input-text Wdate" id="createDateTime"
					placeholder="例如2015-09-08" style="width: 130px;"> <a
