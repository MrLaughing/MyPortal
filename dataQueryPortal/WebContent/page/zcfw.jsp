...
function find() {
	...
	$(function (){
		$("#export").on("click",function(){
			...
			if(orgCode!=""||(registertime_min!=""&&registertime_max!="")){
...
<body>
	...
	新用户服务设置 <a class="btn btn-success radius r mr-20"
