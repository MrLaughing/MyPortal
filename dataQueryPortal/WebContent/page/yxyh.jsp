...
<script type="text/javascript">
function find() {
	var realReceveiTime =  $("#realReceveiTime").val();
	if (realReceveiTime!="") {
		$('#table').datagrid({
			...
			queryParams : {
				realReceveiTime:$("#realReceveiTime").val(),
			},//queryParams 传送的额外参数
			columns : [ [{
				field : '基站名称',
				title : '基站名称'
	...
	$(function (){
		$("#export").on("click",function(){
			var realReceveiTime=document.getElementById("realReceveiTime").value;
			if(realReceveiTime!=""){
...
<body>
	...
	营销用户数 <a class="btn btn-success radius r mr-20"
		...
		<div class="text-c">
			<form action="" name="form1" id="form1" method="post">
				选择时间： <input type="text"
					...
					name="realReceveiTime" id="realReceveiTime" class="input-text Wdate"
					placeholder="例如2015-09-10" style="width: 130px;">
